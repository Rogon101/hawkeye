 ...
 * @author Isamu
 */
public class  Customer_Registry{

    private ArrayList<Customer> C_array;

    static private final Customer_Registry instance = new Customer_Registry();



    private Customer_Registry(){
    ...
    public static Customer_Registry getInstance(){
        return instance;
    }
